...
import { bookAppoinment, cancelAppoinment, getAllAppoinments, getPatient, loginPatient, logoutPatient, registerPatient, updatePatientInfo } from '../controllers/patient.controllers.js';
