...
const TopDoctors = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-16 text-[#262626] md:mx-10'>
       ...
       <button onClick={()=>{navigate('/doctors');scrollTo(0,0)}} className='bg-[#617edf] text-white px-12 py-3 rounded-full mt-10 hover:bg-orange-400 hover:text-lg duration-200'>See More</button>
    </div>
  )
}
